    ...
    return (
        <section class="h-[50vh] md:h-[100vh] flex flex-col items-center">
            ...
            <svg width="600" height="400" xmlns="http://www.w3.org/2000/svg">
                <path d="M  40 80 L  40 200 M  40 200 L 300 320" stroke="black" stroke-width="1" fill="transparent"/>
                ...
                <path d="M 565 80 L 565 200 M 565 200 L 300 320" stroke="black" stroke-width="1" fill="transparent"/>
            </svg>
